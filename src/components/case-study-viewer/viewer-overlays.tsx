...
import { Loader2, AlertCircle, CheckCircle2, Crosshair, Maximize, Info, Keyboard, AlertTriangle, MousePointer2, Ruler, Target, Hand, Move, X, Layers, Eye, EyeOff, Square, Eraser } from 'lucide-react'
...
/** Measurement mode type (re-exported from toolbar for consistency) */
